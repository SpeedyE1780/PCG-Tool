...
namespace pcg::engine::level_generation::tests
{
    ...
    INSTANTIATE_TEST_CASE_P(
        ...
        ::testing::Values(
            ...
            MultiDimensionalGenerationParam{ math::Axis::negativeY | math::Axis::z, "NyZ" },
            MultiDimensionalGenerationParam{ math::Axis::positiveX | math::Axis::negativeY | math::Axis::z, "PxNyZ" },
            MultiDimensionalGenerationParam{ math::Axis::negativeX | math::Axis::negativeY | math::Axis::z, "NxNyZ" },
