...
namespace pcg::engine::maze_generation
{
    ...
    inline constexpr Grid generateGrid(int width, int height, utility::enums::Direction defaultValue = utility::enums::Direction::none) { return Grid(height, std::vector<utility::enums::Direction>(width, defaultValue)); }
