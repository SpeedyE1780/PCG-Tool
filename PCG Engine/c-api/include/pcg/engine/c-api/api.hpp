...
namespace pcg::engine::c_api
{
    ...
    /// @param callback Callback when a node is generated
    PCG_ENGINE_C_API_API void multiDimensionGeneration(level_generation::GenerationData* data, math::Axis axes, bool disableOverlap, addNodeCallback&& callback);
    ...
    /// @param axes Axes flag indicating which axes are being used
    /// @param callback Callback when a node is generated
    PCG_ENGINE_C_API_API void waveFunctionCollapseGeneration(level_generation::GenerationData* data, level_generation::ExpansionMode mode, math::Axis axes, addWFCNodeCallback&& callback);
